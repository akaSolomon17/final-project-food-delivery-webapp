...
import { useCartActions, useTotalPrice, useDiscountInfo, useIsVoucherApplied } from '../zustand/cartStore.ts';
...
const useVoucher = () => {
    ...
    return { appliedVouchers, applyVoucher, removeVoucher, priceReduce, totalPriceDiscount };
};
