  ...
  return (
    <div className="footer">
      <div className="page-footer w-full h-[20rem] pt-5 border-t-1 shadow-inner bg-[#f7fafc93] flex flex-col justify-center select-none">
        <h1 className="font-semibold font-sans ms-[21rem] text-lg">
          Deok Sun Korean Food.
        </h1>
          ...
          <ul className="flex flex-col gap-1">
            ...
            <li>
              <img
                ...
                alt="Google Badge"
                className="max-w-[45%] mt-3"
              />
            </li>
          </ul>
        </div>
        <span className="text-default w-full font-normal text-right pe-[30rem] mt-10">
