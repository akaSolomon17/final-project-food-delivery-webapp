...
import { useDataFeedbacks, usePage, useReviewsActions } from '../../../zustand/reviewsStore.ts'

const Comments: React.FC<{ isLoading: boolean, totalPages: number | undefined }> = ({ isLoading, totalPages }) => {
    ...
    return (
        <>
            ...
            {totalPages && page < totalPages && (<LoadMore content={isLoading ? 'Loading...' : 'Load more comments'} clickEvent={() => setPage(page + 1)} />)}
        </>
    )
}
